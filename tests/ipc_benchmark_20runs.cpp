...
int main() {
    ...
    std::cout << "=========================================================================================================\n";
    std::cout << "     20 REPEATED 2,000,000 FRAME REAL PROCESS IPC BENCHMARK                                             \n";
    std::cout << "=========================================================================================================\n";
    ...
    auto calcStats = [](std::vector<double> v) {
        ...
        return std::make_tuple(min_v, p25, median, mean, p75, p90, p95, max_v, stddev);
    };

    auto [wallMin, wallP25, wallMed, wallMean, wallP75, wallP90, wallP95, wallMax, wallStd] = calcStats(wallTimesSec);
    auto [cpuMin, cpuP25, cpuMed, cpuMean, cpuP75, cpuP90, cpuP95, cpuMax, cpuStd] = calcStats(solverCpuSec);

    std::cout << "\n=========================================================================================================\n";
    std::cout << "     20-RUN IPC BENCHMARK FULL PERCENTILE BREAKDOWN (SECONDS)\n";
    std::cout << "=========================================================================================================\n";
    std::cout << "  Metric      Min(s)   P25(s)   P50(s)   Mean(s)  P75(s)   P90(s)   P95(s)   Max(s)   StdDev(s) Target\n";
    std::cout << "---------------------------------------------------------------------------------------------------------\n";
    std::cout << "  Wall Clock  " << std::setw(9) << std::fixed << std::setprecision(3) << wallMin
              << std::setw(9) << wallP25
              << std::setw(9) << wallMed
              << std::setw(9) << wallMean
              << std::setw(9) << wallP75
              ...
              << std::setw(10) << wallStd
              << "P50<=12.5, P95<=13.5\n";
    std::cout << "  Solver CPU  " << std::setw(9) << cpuMin
              << std::setw(9) << cpuP25
              << std::setw(9) << cpuMed
              << std::setw(9) << cpuMean
              << std::setw(9) << cpuP75
